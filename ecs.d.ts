...
export type Archetype = {
	HasComponent: Set<AnyEntity>
}
export type AnyEntity = {
	/** The debug name associated with this entity */
	Name?: string
}
export type Entity = Reconstruct<AnyEntity & { __entity: true }>
export type Component<Data> = Reconstruct<
	AnyEntity & {
		__data: Data
		OnAdd?: (e: AnyEntity, value: Data) => void
		OnChange?: (e: AnyEntity, value: Data, prev: Data) => void
		OnRemove?: (e: AnyEntity, prev: Data) => void
		OnDelete?: (e: AnyEntity, prev: Data) => void
	}
>
export type Flag = Reconstruct<
	AnyEntity & {
		IsFlag: true
		OnAdd?: (e: AnyEntity) => void
		OnRemove?: (e: AnyEntity) => void
		OnDelete?: (e: AnyEntity) => void
	}
>
...
export type Query<T extends unknown[]> = Iter<T> & {
	...
	With(...components: AnyEntity[]): Query<T>
	/** Only iterate over entities that do *not* have the specified components */
	Without(...components: AnyEntity[]): Query<T>
...
type InferComponentValues<A extends AnyEntity[]> = {
...
export class World {
	...
	Add(e: AnyEntity, C: Flag): void
	Has(e: AnyEntity, C: AnyEntity): boolean
	...
	Set<Data>(e: AnyEntity, C: Component<Data>, value: Data): void
	/** You can also get the data directly via e[C], so long as you treat it as read-only. */
	Get<Data>(e: AnyEntity, C: Component<Data>): Data | undefined
	Remove(e: AnyEntity, C: Flag): void
	Remove<Data>(e: AnyEntity, C: Component<Data>): void
	...
	Delete(e: AnyEntity): void
	/** True if `e` is an undeleted entity. */
	IsLiveEntity(e: unknown): e is AnyEntity
	 ...
	 */
	Query<T extends AnyEntity[]>(...components: T): Query<InferComponentValues<T>>
	...
	OnAdd(C: Flag, onAdd: (e: AnyEntity) => void): void
	OnAdd<Data>(C: Component<Data>, onAdd: (e: AnyEntity, value: Data) => void): void
	...
	OnChange<Data>(C: Component<Data>, onChange: (e: AnyEntity, value: Data, prev: Data) => void): void
	/** Extends any OnRemove behaviour defined for `C`.\
	 * Triggered when C is removed from an entity. */
	OnRemove(C: Flag, onRemove: (e: AnyEntity) => void): void
	OnRemove<Data>(C: Component<Data>, onRemove: (e: AnyEntity, prev: Data) => void): void
	...
	OnDelete(C: Flag, onDelete: (e: AnyEntity) => void): void
	/** Extends any OnDelete behaviour defined for `C`.\
	 ...
	 */
	OnDelete<Data>(C: Component<Data>, onDelete: (e: AnyEntity, prev: Data) => void): void
}
